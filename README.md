...
There is also and extension for interacting with the [MAL Simulator](https://github.com/mal-lang/mal-simulator), which can be found at [vejde-malsim](https://github.com/mal-lang/vejde-malsim) 
